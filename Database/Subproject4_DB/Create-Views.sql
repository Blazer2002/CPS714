...
CREATE VIEW PRODUCTUPGRADEREWARDVIEW AS
	...
	FROM REWARDS AS R
		...
		INNER JOIN PRODUCTS AS A
			ON U.PrevProductFK = A.Reward_ID
		INNER JOIN PRODUCTS AS B
			ON U.NextProductFK = B.Reward_ID;
        
	-- WHERE
-- 		R.Reward_ID = P.Reward_ID,
--         A.Product_ID = P.PrevProductFK,
--         B.Product_ID = P.NextProductFK;
        
    
   --  INNER JOIN PRODUCTUPGRADEREWARD AS P
-- 		ON 	R.Reward_ID = P.Reward_ID
--         INNER JOIN PRODUCTS AS A
-- 		    ON 	A.Product_ID = P.PrevProductFK
--         INNER JOIN PRODUCTS AS B
-- 		    ON 	B.Product_ID = P.NextProductFK;
